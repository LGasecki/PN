.cseg         
.org 0    
; segment pamiêci kodu programu  
rjmp MainLoop
; skok po resecie (do programu g³ównego) 
.org OC1Aaddr  rjmp _timer_isr ; skok do obs³ugi przerwania timera 
_timer_isr:    
; procedura obs³ugi przerwania timera 
inc R0  
reti    
; jakiœ kod 
; powrót z procedury obs³ugi przerwania (reti zamiast ret)  
